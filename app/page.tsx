...
>
  ENTER CODE
      ...
      <div
  aria-hidden="true"
  className="absolute left-[-145px] top-1/2 h-[300px] w-[300px] -translate-y-1/2 rotate-45 border border-gray-200 md:left-[-160px] md:h-[430px] md:w-[430px] md:border-gray-300"
/>

     <div
  aria-hidden="true"
  className="absolute right-[-145px] top-1/2 h-[300px] w-[300px] -translate-y-1/2 rotate-45 border border-gray-200 md:right-[-160px] md:h-[430px] md:w-[430px] md:border-gray-300"
/>
     ...
     <button
  type="button"
  className="discover-ai absolute left-[26%] top-[62%] flex -translate-x-1/2 items-center gap-2 text-[7px] font-bold transition-all duration-300 hover:scale-105 md:left-20 md:top-1/2 md:translate-x-0 md:-translate-y-1/2 md:gap-4 md:text-sm"
>
  <span
  aria-hidden="true"
  className="flex h-6 w-6 rotate-45 items-center justify-center border border-black md:h-12 md:w-12"
>
